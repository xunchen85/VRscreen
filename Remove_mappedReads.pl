...
#####
if($line[1]%8>=4){
  print "$direction $line[0] 0 $start1 $end $length 0 0 0 $direction @line[1..3] @line[5..8] $line[13]\n";
                 }
elsif($line[1]%16>=8){
  if($direction eq "L"){
    print "$direction $line[0] 0 $start1 $end $length 0 0 0 $direction @line[1..3] @line[5..8] $line[13]\n";
    ...
    print "$direction $line[0] 0 0 0 0 $start1 $end $length $direction @line[1..3] @line[5..8] $line[13]\n";
      }
                     }
#####
else{
...
#############
    print "$note $line1[0] $distance @line1[1..3] @line2[1..3] @line1[4..12] @line2[4..12]\n";
                             }
  else{
   print "E $line1[0] 0 0 0 0 0 0 0 @line1[4..12]\n";}
                    }
 else{
...
#############
   print "$note $line1[0] $distance @line2[1..3] @line1[1..3] @line2[4..12] @line1[4..12]\n";
                             }
  else{
   print "E $line1[0] 0 0 0 0 0 0 0 @line1[4..12]\n";}
      }
